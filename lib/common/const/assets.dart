...
class AppAsset {
  ...
  static const GAME_ID_GUIDE_GIF = "$VIDEO_PATH/game_id.gif";
  ...
  static const APP_LOGO = "$LOGO_PATH/app_logo.png";
  ...
  static const TAGS = "$COMMU_PATH/tag.svg"; // 태그 아이콘

  static const CAMERA_ON = "$COMMU_PATH/camera_on.png"; // 카메라 아이콘
  static const CAMERA_OFF = "$COMMU_PATH/camera_off.png"; // 카메라 아이콘

  static const GALLER_ON = "$COMMU_PATH/gallery_on.png"; // 갤러리 아이콘
  static const GALLERY_OFF = "$COMMU_PATH/gallery_off.png"; // 갤러리 아이콘

  static const YOUTUBE_ON = "$COMMU_PATH/youtube_on.png"; // 유튜브 아이콘
  static const YOUTUBE_OFF = "$COMMU_PATH/youtube_off.png"; // 유튜브 아이콘

  static const NAV_HOME_ON = "$COMMU_PATH/home_28on.png"; // 바텀 네비 홈
  static const NAV_HOME_OFF = "$COMMU_PATH/home_28off.png"; // 바텀 네비 홈

  static const NAV_WRITE_ON = "$COMMU_PATH/write_28on.png"; // 바텀 네비 글쓰기
  static const NAV_WRITE_OFF = "$COMMU_PATH/write_28off.png"; // 바텀 네비 글쓰기

  // static const NAV_MY_ON = "$COMMU_PATH/01.png";
  static const NAV_MY_OFF = "$COMMU_PATH/my_28off.png"; // 바텀 네비 마이페이지

  // static const NAV_LIKE_ON = "$COMMU_PATH/01.png";
  static const NAV_LIKE_OFF = "$COMMU_PATH/like_28off.png"; // 바텀 네비 좋아요

  // static const NAV_CHAT_ON = "$COMMU_PATH/01.png";
  static const NAV_CHAT_OFF = "$COMMU_PATH/chat_28off.png"; // 바텀 네비 채팅
